...
void register_min_max(){
  ...
  while(zero < 15){
    ...
    if(receiver_input_channel_3 < center_channel_3 + 20 && receiver_input_channel_3 > center_channel_3 - 20)zero |= 0b00000100;
    if(receiver_input_channel_4 < center_channel_4 + 20 && receiver_input_channel_4 > center_channel_4 - 20)zero |= 0b00001000;
    if(receiver_input_channel_1 < low_channel_1)low_channel_1 = 1000;
    if(receiver_input_channel_2 < low_channel_2)low_channel_2 = 1000;
    if(receiver_input_channel_3 < low_channel_3)low_channel_3 = 1000;
    if(receiver_input_channel_4 < low_channel_4)low_channel_4 = 1000;
    if(receiver_input_channel_1 > high_channel_1)high_channel_1 =2000;
    if(receiver_input_channel_2 > high_channel_2)high_channel_2 = 2000;
    if(receiver_input_channel_3 > high_channel_3)high_channel_3 = 2000;
    if(receiver_input_channel_4 > high_channel_4)high_channel_4 = 2000;
    delay(100);
  }
}
