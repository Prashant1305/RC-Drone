...
void loop(){
  ...
  if (start == 2){                                                          //The motors are started.
    ...
    if (esc_1 < 1100) esc_1 = 1080;                                         //Keep the motors running.
    if (esc_2 < 1100) esc_2 = 1080;                                         //Keep the motors running.
    if (esc_3 < 1100) esc_3 = 1080;                                         //Keep the motors running.
    if (esc_4 < 1100) esc_4 = 1080;                                         //Keep the motors running.
